...
为 V2EX 提供主题、布局、导航和阅读增强。当前版本 **1.13.53**，提供 **单文件油猴脚本**、**Chrome 扩展**和 **Safari Web Extension**。
...
- 修复移动主题操作仅匹配 a.tb 的遗漏，兼容链接、按钮和 input 按钮，保留原生事件与文字状态。
- 清理开启对话入口旁的原生表情图标，避免双图标。
